...
class Net(nn.Module):
    def __init__(self, input_nc=3, output_nc=3, ngf=128,
    ...
    async def run_style_transfer(self, content_img, style_img):
        await asyncio.sleep(1 / 10)

        content_image = tensor_load_rgbimage(content_img, size=512,
...
def tensor_load_rgbimage(file, size=None, scale=None, keep_asp=False):
